...
auto builtin_records() -> std::vector<CapabilityRecord> {
    ...
    return {
        ...
        format_record(RelocatableObjectParsing, PE, Supported, {}, {"linked_image"}),
        ...
        format_record(RelocatableObjectParsing, Archive, Supported, {}, {"archive"}),

        format_record(LinkedImageParsing, PE, Supported, {}, {"linked_image"}),
        format_record(LinkedImageParsing, COFF, Supported, {}, {"coff_object_parser"}),
        format_record(LinkedImageParsing, ELF, Supported, {}, {"linked_image"}),
        format_record(LinkedImageParsing, MachO, Supported, {}, {"linked_image"}),
        format_record(LinkedImageParsing, Archive, Supported, {}, {"archive"}),
        ...
        format_record(BaselineMetadataTransformation, PE, Supported, {}, {"baseline_transforms"}),
        format_record(BaselineMetadataTransformation, COFF, Supported, {}, {"baseline_transforms"}),
        format_record(BaselineMetadataTransformation, ELF, Supported, {}, {"baseline_transforms"}),
        format_record(BaselineMetadataTransformation, MachO, Supported, {}, {"baseline_transforms"}),
        format_record(BaselineMetadataTransformation, Archive, Supported, {}, {"baseline_transforms"}),

        format_record(MachineCodeTransformation, PE, Supported, {}, {"instruction_transforms"}),
        ...
        format_record(MachineCodeTransformation, Archive, Supported, {}, {"instruction_transforms"}),

        format_record(VmLowering, PE, Supported, {}, {"linked_vm_lowering"}),
        format_record(VmLowering, COFF, Supported, {}, {"archive_vm_lowering"}),
        format_record(VmLowering, ELF, Supported, {}, {"archive_vm_lowering"}),
        format_record(VmLowering, MachO, Supported, {}, {"archive_vm_lowering"}),
        format_record(VmLowering, Archive, Supported, {}, {"archive_vm_lowering"}),

        format_record(VmProtection, PE, Supported, {}, {"archive_vm_protection"}),
        format_record(VmProtection, COFF, Supported, {}, {"archive_vm_protection"}),
        format_record(VmProtection, ELF, Supported, {}, {"archive_vm_protection"}),
        format_record(VmProtection, MachO, Supported, {}, {"archive_vm_protection"}),
        format_record(VmProtection, Archive, Supported, {}, {"archive_vm_protection"}),
